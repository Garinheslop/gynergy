...
export const VALUE_STACK: ValueStackItem[] = [
  ...
  },
  {
    ...
    description:
      "Share a personalized discount link with a friend. When they join, both of you benefit. Hold each other accountable when motivation fades.",
    value: "$997",
  },
];
...
export const TIMELINE: TimelineItem[] = [
  ...
  },
  {
    week: "Days 1-9",
    name: "Shadow Work",
    description: "Confronting what lies beneath the surface. Foundation.",
  },
  {
    week: "Days 10-18",
    name: "Self-Forgiveness",
    description: "Releasing the weight you have been carrying.",
  },
  {
    week: "Days 19-27",
    name: "Awakening",
    description: "Seeing yourself and your life with clarity.",
  },
  {
    week: "Days 28-36",
    name: "Vision & Goals",
    description: "Mapping your next chapter with intention.",
  },
  {
    week: "Days 37-45",
    name: "Action Through Gratitude",
    description: "Turning insight into daily practice.",
  },
  {
    week: "Days 46-66",
    name: "Bridge: Integration",
    description: "Lighter practice. Morning-only. Habit locks in.",
  },
  {
    week: "Day 66",
    name: "Habit Milestone",
    description: "The science says the habit is now automatic.",
    isHighlight: true,
  },
];
