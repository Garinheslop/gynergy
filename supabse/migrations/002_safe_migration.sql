-- ==============================================
-- GYNERGY SAFE DATABASE MIGRATION
...
-- Users
DROP POLICY IF EXISTS "Users can CRUD own profile" ON users;

-- Books
DROP POLICY IF EXISTS "Authenticated users can read books" ON books;
DROP POLICY IF EXISTS "Only Admins can crud books" ON books;
DROP POLICY IF EXISTS "Admins can CRUD books" ON books;
DROP POLICY IF EXISTS "Authenticated users can read book sesssions" ON book_sessions;
DROP POLICY IF EXISTS "Admins can CRUD book sessions" ON book_sessions;
DROP POLICY IF EXISTS "Authenticated users can read book milestones" ON book_milestones;

-- Cohorts
DROP POLICY IF EXISTS "Anyone can view public cohorts" ON cohorts;
DROP POLICY IF EXISTS "Members can view their cohorts" ON cohorts;
DROP POLICY IF EXISTS "Admins can update cohorts" ON cohorts;
DROP POLICY IF EXISTS "Users can view memberships in their cohorts" ON cohort_memberships;
DROP POLICY IF EXISTS "Users can join public cohorts" ON cohort_memberships;
DROP POLICY IF EXISTS "Users can leave cohorts" ON cohort_memberships;
DROP POLICY IF EXISTS "Admins can manage memberships" ON cohort_memberships;

-- Video rooms
DROP POLICY IF EXISTS "Users can view rooms they host" ON video_rooms;
DROP POLICY IF EXISTS "Users can view rooms they participate in" ON video_rooms;
DROP POLICY IF EXISTS "Users can view cohort rooms they're members of" ON video_rooms;
DROP POLICY IF EXISTS "Hosts can manage their rooms" ON video_rooms;
DROP POLICY IF EXISTS "Users can view participants in their rooms" ON video_room_participants;
DROP POLICY IF EXISTS "Users can manage own participation" ON video_room_participants;
DROP POLICY IF EXISTS "Hosts can manage participants" ON video_room_participants;
DROP POLICY IF EXISTS "Authors can manage own notes" ON video_call_notes;
DROP POLICY IF EXISTS "Hosts can view all notes in their rooms" ON video_call_notes;
DROP POLICY IF EXISTS "Anyone can view active templates" ON video_room_templates;
DROP POLICY IF EXISTS "Creators can manage their templates" ON video_room_templates;
DROP POLICY IF EXISTS "Users can view their invitations" ON video_room_invitations;
DROP POLICY IF EXISTS "Users can respond to their invitations" ON video_room_invitations;
DROP POLICY IF EXISTS "Hosts can send invitations" ON video_room_invitations;

-- ==============================================
-- GYNERGY COMPLETE DATABASE SCHEMA
