...
export const metadata: Metadata = {
  ...
  description:
    "For successful people who built everything and feel nothing. 45 days to fix the multiplier across wealth, health, relationships, mindset, and legacy. Limited to 15 seats.",
  keywords: [
...
const structuredData = {
  ...
  description:
    "A 45-day transformation program for successful people across five life pillars: wealth, health, relationships, mindset, and legacy.",
  provider: {
    "@type": "Organization",
    name: "GYNERGY",
    url: "https://www.gynergy.app",
