...
import { Tabs } from "@modules/common/components/ui";
    ...
    <AdminLayout title="Content Management" subtitle="Manage challenge content, videos, and quotes">
      ...
      <Tabs defaultValue="challenge">
        <Tabs.List className="mb-6">
          <Tabs.Tab value="challenge">
            <i className="gng-calendar mr-2" aria-hidden="true" />
            Challenge Days
          </Tabs.Tab>
          <Tabs.Tab value="videos">
            <i className="gng-play mr-2" aria-hidden="true" />
            Video Library
          </Tabs.Tab>
          <Tabs.Tab value="quotes">
            <i className="gng-quote mr-2" aria-hidden="true" />
            Quotes
          </Tabs.Tab>
        </Tabs.List>
                ...
                {(!data.content.challengeDays || data.content.challengeDays.length === 0) && (
                  <div className="border-grey-800 bg-grey-900 rounded-xl border p-12 text-center">
                    ...
                    <p className="text-grey-400 mb-4">
                      Start building your 45-day challenge content
                    </p>
                    <button
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {data.content.quotes?.map((quote) => (
                    <div
                      key={quote.id}
                      className="border-grey-800 bg-grey-900 rounded-xl border p-4"
                    >
